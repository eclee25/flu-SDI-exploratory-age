...
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE (flu.SERVICE_PLACE = "INPATIENT ACUTE CARE FACILITY" OR flu.SERVICE_PLACE = "EMERGENCY ROOM/URGENT CARE FAC") and flu.PATIENT_ZIP3 = "TOT"
...
SELECT season.SEASON_NUM, child.MARKER, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 1
...
SELECT season.SEASON_NUM, child.MARKER, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 2
GROUP BY season.SEASON_NUM, flu.WEEK, child.MARKER
...
SELECT season.SEASON_NUM, child.MARKER, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 3
GROUP BY season.SEASON_NUM, flu.WEEK, child.MARKER
...
SELECT season.SEASON_NUM, child.MARKER, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 4
GROUP BY season.SEASON_NUM, flu.WEEK, child.MARKER
...
SELECT season.SEASON_NUM, child.MARKER, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 5
GROUP BY season.SEASON_NUM, flu.WEEK, child.MARKER
...
SELECT season.SEASON_NUM, child.MARKER, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 6
GROUP BY season.SEASON_NUM, flu.WEEK, child.MARKER
...
SELECT season.SEASON_NUM, child.MARKER, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 7
GROUP BY season.SEASON_NUM, flu.WEEK, child.MARKER
...
SELECT season.SEASON_NUM, child.MARKER, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 8
GROUP BY season.SEASON_NUM, flu.WEEK, child.MARKER
...
SELECT season.SEASON_NUM, child.MARKER, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 9
GROUP BY season.SEASON_NUM, flu.WEEK, child.MARKER
...
SELECT season.SEASON_NUM, child.MARKER, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 10
GROUP BY season.SEASON_NUM, flu.WEEK, child.MARKER
...
SELECT season.SEASON_NUM, flu.WEEK, sum(ILI_m)
from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT" and season.SEASON_NUM = 1 and (flu.AGEGROUP = '5-9 YEARS' OR flu.AGEGROUP = '10-14 YEARS' OR flu.AGEGROUP = '15-19 YEARS')
...
SELECT season.SEASON_NUM, child.MARKER, sum(ANY_DIAG_VISIT_CT)
from flu RIGHT JOIN season on (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
...
SELECT season.SEASON_NUM, child.MARKER, year(flu.week), sum(ANY_DIAG_VISIT_CT)
from flu RIGHT JOIN season on (flu.WEEK = season.WEEK) RIGHT JOIN child ON (child.AGEGROUP = flu.AGEGROUP)
WHERE flu.SERVICE_PLACE = "TOTAL" and flu.PATIENT_ZIP3 = "TOT"
GROUP BY season.SEASON_NUM, year(flu.week), child.MARKER
;
SELECT season.SEASON_NUM, sum(ANY_DIAG_VISIT_CT) from flu RIGHT JOIN season ON (flu.WEEK = season.WEEK)
