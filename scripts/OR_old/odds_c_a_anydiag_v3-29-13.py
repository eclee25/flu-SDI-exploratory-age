...
plt.plot(x2, y2e[-13], marker='o', color = 'gold', label= "04-05")
...
plt.plot(x2, y2j[-13], marker='o', color = 'hotpink', label= "season 09-10")
plt.xlabel('Week number')
plt.ylabel('Child:Adult attack rate (any visit ct normalized)')
ylim([0,15])
