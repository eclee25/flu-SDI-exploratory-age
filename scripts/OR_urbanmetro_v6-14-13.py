...
zORin=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_bysseas_cl_v6-12-13.csv','r') # use to calculate OR by zip3
zOR=csv.reader(zORin, delimiter=',')
zOR1in=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_cl_1v6-12-13.csv','r') # use to calculate OR by zip3 (one season chart)
zOR1=csv.reader(zOR1in, delimiter=',')
zOR2in=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_cl_2v6-12-13.csv','r') # use to calculate OR by zip3 (one season chart)
zOR2=csv.reader(zOR2in, delimiter=',')
zOR3in=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_cl_3v6-12-13.csv','r') # use to calculate OR by zip3 (one season chart)
zOR3=csv.reader(zOR3in, delimiter=',')
zOR4in=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_cl_4v6-12-13.csv','r') # use to calculate OR by zip3 (one season chart)
zOR4=csv.reader(zOR4in, delimiter=',')
zOR5in=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_cl_5v6-12-13.csv','r') # use to calculate OR by zip3 (one season chart)
zOR5=csv.reader(zOR5in, delimiter=',')
zOR6in=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_cl_6v6-12-13.csv','r') # use to calculate OR by zip3 (one season chart)
zOR6=csv.reader(zOR6in, delimiter=',')
zOR7in=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_cl_7v6-12-13.csv','r') # use to calculate OR by zip3 (one season chart)
zOR7=csv.reader(zOR7in, delimiter=',')
zOR8in=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_cl_8v6-12-13.csv','r') # use to calculate OR by zip3 (one season chart)
zOR8=csv.reader(zOR8in, delimiter=',')
zOR9in=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_cl_9v6-12-13.csv','r') # use to calculate OR by zip3 (one season chart)
zOR9=csv.reader(zOR9in, delimiter=',')
zOR10in=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/R_export/zipcode_cl_10v6-12-13.csv','r') # use to calculate OR by zip3 (one season chart)
zOR10=csv.reader(zOR10in, delimiter=',')
RUCCavgin=open('/home/elee/Dropbox/Elizabeth_Bansal_Lab/SDI_Data/explore/Rural_Urban/R_export/zip3_RUCC2013avg_crosswalk.csv','r') # categorization of urban/rural by zip3
...
### calculate average OR and standard dev for each bin 10/16/13
metroOR = np.mean([OR for bin, OR in zip(rucc_bin, y1) if bin == 1])
smallmetroOR = np.mean([OR for bin, OR in zip(rucc_bin, y1) if bin == 2])
ruralOR = np.mean([OR for bin, OR in zip(rucc_bin, y1) if bin == 3])
