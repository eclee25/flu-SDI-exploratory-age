...
### Extract classification counts by state from create_fluseverity_figs/evaluate_state_early_warning.py 
## Data Source: 
...
setwd('/home/elee/Dropbox/Elizabeth_Bansal_Lab/Manuscripts/Age_Severity/fluseverity_figs/F4')
