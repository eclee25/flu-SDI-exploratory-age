...
###Command Line: python ILINet_F2_incid_time.py
##############################################
...
plt.savefig('/home/elee/Dropbox/Elizabeth_Bansal_Lab/Manuscripts/Age_Severity/fluseverity_figs/ILINet/incid_time.png', transparent=False, bbox_inches='tight', pad_inches=0)
plt.close()
