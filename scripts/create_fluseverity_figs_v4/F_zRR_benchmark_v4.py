...
###Command Line: python F3_zOR_benchmark_v4.py
##############################################
...
# d_classifzOR[seasonnum] = (mean retrospective zOR, mean early warning zOR)
d_classifzOR = fxn.classif_zRR_processing(d_wk, d_totIncidAdj53ls, d_zRR53ls, thanks)
...
ax1.set_xlim([-5,5])
ax1.set_ylim([-15,15])
plt.savefig('/home/elee/Dropbox/Elizabeth_Bansal_Lab/Manuscripts/Age_Severity/fluseverity_figs_v4/zRR_benchmark.png', transparent=False, bbox_inches='tight', pad_inches=0)
plt.close()
# plt.show()
...
ax2.set_xlim([-5,5])
ax2.set_ylim([-10,10])
plt.savefig('/home/elee/Dropbox/Elizabeth_Bansal_Lab/Manuscripts/Age_Severity/fluseverity_figs_v4/zRR_benchmark_early.png', transparent=False, bbox_inches='tight', pad_inches=0)
plt.close()
# plt.show()
