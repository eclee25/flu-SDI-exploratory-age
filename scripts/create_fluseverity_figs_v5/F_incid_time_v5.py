...
plt.savefig(os.path.join(cwd, '../../../../Manuscripts/Age_Severity/fluseverity_figs_v5/Supp/incid_time.png'), transparent=False, bbox_inches='tight', pad_inches=0, dpi=300)
plt.close()
# plt.show()
