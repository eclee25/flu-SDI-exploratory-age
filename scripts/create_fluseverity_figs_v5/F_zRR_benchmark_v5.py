...
ax1.set_xlim([-5,5])
ax1.set_ylim([-15,15])
plt.savefig('/home/elee/Dropbox/Elizabeth_Bansal_Lab/Manuscripts/Age_Severity/fluseverity_figs_v5/zRR_benchmark.png', transparent=False, bbox_inches='tight', pad_inches=0)
plt.close()
# plt.show()
...
ax2.set_xlim([-5,5])
ax2.set_ylim([-10,10])
plt.savefig('/home/elee/Dropbox/Elizabeth_Bansal_Lab/Manuscripts/Age_Severity/fluseverity_figs_v5/zRR_benchmark_early.png', transparent=False, bbox_inches='tight', pad_inches=0)
plt.close()
# plt.show()
