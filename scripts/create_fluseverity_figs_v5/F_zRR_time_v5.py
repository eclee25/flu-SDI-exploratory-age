...
###Command Line: python F_zOR_time_v5.py
##############################################
...
plt.savefig('/home/elee/Dropbox/Elizabeth_Bansal_Lab/Manuscripts/Age_Severity/fluseverity_figs_v5/zRR_time.png', transparent=False, bbox_inches='tight', pad_inches=0)
plt.close()
# plt.show()
