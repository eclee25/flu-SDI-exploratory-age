...
plt.savefig('/home/elee/Dropbox/Elizabeth_Bansal_Lab/Manuscripts/Age_Severity/fluseverity_figs_v5/exploratory/corrCoef_window_fallBL.png', transparent=False, bbox_inches='tight', pad_inches=0)
plt.close()
# plt.show()
