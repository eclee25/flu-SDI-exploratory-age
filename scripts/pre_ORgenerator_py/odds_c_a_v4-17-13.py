...
## from 3/29: 
# data input changed --limit seasons from week 40 of y1 to week 20 of y2
# for years w/o week 53, wk 53 data was generated by averaging the attack rates of wk 52 and wk 1 of the next year

###Import data: odds_c_a1.csv, odds_c_a3_a, odds_c_a3_b, odds_c_a2_a through j

###Command Line: python odds_c_a_v4-17-13.py
##############################################
...
# plot (drop first season of data because it is not complete)
...
plt.ylabel('Odds ratio of attack rate, child:adult (US popn normalized)') #5-16-13 changed label
ylim([-1,7])
...
avg53(d2b, adult2b, child2b, 3)
avg53(d2c, adult2c, child2c, 3)
avg53(d2d, adult2d, child2d, 3)
importer(d2e, adult2e, child2e, 3)
avg53(d2f, adult2f, child2f, 3)
avg53(d2g, adult2g, child2g, 3)
avg53(d2h, adult2h, child2h, 3)
avg53(d2i, adult2i, child2i, 3)
importer(d2j, adult2j, child2j, 3)
x2 = range(0,34)
x2lab=range(40,54)+range(1,21)
